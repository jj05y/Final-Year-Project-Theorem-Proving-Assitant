...
\newcommand{\hmwkDesc}{A report submitted in part fulfilment of the \\degree of
BSc. (Hons.) in Computer Science} % Due date
...
\end{homeworkProblem}
%----------------------------------------------------------------------------------------
\begin{homeworkProblem}[Explorations into the Field]
