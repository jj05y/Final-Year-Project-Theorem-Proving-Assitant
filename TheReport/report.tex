...
In this section the functionality of the Theorem proving assistant is demonstrated. It shows a complete proof from start to finish.
...
\begin{center}
\includegraphics[width=0.4\columnwidth]{../screenshot} % Example image
\end{center}
...
\end{homeworkSection}
\begin{homeworkSection}{Carrying out a Proof Step}
great
